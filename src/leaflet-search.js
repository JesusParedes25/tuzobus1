...
(function (factory) {
  ...
  L.Control.Search = L.Control.extend({
    ...
    options: {
      ...
      delayType: 800, // delay while typing for show tooltip
      ...
      textErr: 'No se encontró ningún municipio', // error message
      textCancel: 'Cancelar búsqueda', // title in cancel button
      textPlaceholder: 'Busca algún municipio...', // plhaceholder value
